...
BT.store = (() => {
  ...
  function finishActiveSession(summary = {}, id = null) {
    ...
    if (summary.traceText) saveTrace({ bookId: session.bookId, sessionId: saved.id, text: summary.traceText, formatting:summary.traceFormatting ?? session.traceFormatting, page: summary.endPage ?? session.endPage, privacy: summary.share ? 'public' : 'private' });
