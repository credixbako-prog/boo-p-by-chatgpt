...
BT.badges = (() => {
  ...
  const art = {
    reading:'<g class="badge-moving"><path d="M32 31h34a5 5 0 0 1 5 5v40H36a5 5 0 0 1-5-5V33Z" fill="#183149"/><path d="M37 32v39m0 0h34M41 40h21M41 45h14"/><path d="M31 71q0 6 6 6h35"/></g><path class="badge-accent" d="M56 31v23l6-4 6 4V31" fill="#cca364"/>',
    ...
    exploration:'<circle cx="52" cy="52" r="25"/><path d="M52 22v8m0 44v8M22 52h8m44 0h8"/><g class="badge-moving"><path d="m42 63 6-16 15-6-6 16Z" fill="#cca364"/><path d="m48 47 9 10"/></g><circle cx="52" cy="52" r="2" fill="#183149"/>',
  ...
  function artwork(badge) {
    ...
    return `<svg class="badge-art badge-art--${family}" viewBox="0 0 104 104" aria-hidden="true" focusable="false" fill="none" stroke="#183149" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="52" cy="52" r="49" fill="#f7f3e9" stroke="#c9b68e"/><circle cx="52" cy="52" r="44" stroke="#d9dfd3"/><path d="m19 30 2-5 2 5 5 2-5 2-2 5-2-5-5-2Z" fill="#cca364" stroke="none"/>${variants[badge.id]||art[family]}${marks}</svg>`;
  }
  function chip(badge) {
