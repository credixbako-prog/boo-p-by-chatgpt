...
do $$ begin
 ...
 update public.publication_reports set status='reviewed' where reporter_id=auth.uid();if found then raise exception 'Reporter updated moderation status';end if;
...
do $$ begin
 ...
 update public.publication_reports set status='reviewed' where reporter_id='b97b3fa0-3210-4134-9d03-000000000002';if not found then raise exception 'Moderator cannot process report';end if;
